...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.124/skip.zip", checksum: "f03a62ebd82527607704e63c78b633ea164a80f18c5f8007e29d3d81d2744def")
    ]
)
