...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.75/skip.zip", checksum: "3693e505ca7288d5aace2bbb8bbf177dae31b710d949a09d3dab766a83f82395")
    ]
)
