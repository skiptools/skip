...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.96/skipstone.plugin.zip", checksum: "a996095bcc00baa0f4bf8e9bfae63506bbf906ba306e5c8855e9c5fa871ac203")
    ]
)
