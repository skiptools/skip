...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.25/skip.zip", checksum: "6c9055643a5b2d1b404cdf61a97cd60abd74908b623142a8d77a74c913ab4bb0")
    ]
)
