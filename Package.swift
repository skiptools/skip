...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.44/skip.zip", checksum: "1a45b09370199704ab86ce431b369185e1d4e13b8ae288607a36241ac80f7114")
    ]
)
