...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.16/skip.zip", checksum: "ab09a2f5e3dd4a53a620276e71fc8760923db56394fea39c7f2d5cec41ba920c")
    ]
)
