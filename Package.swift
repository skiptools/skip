...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.16/skip.zip", checksum: "183cf2f0515acdeae168fedcad40e2fb870f6265a7116e7cdc06ac31183982bb")
    ]
)
