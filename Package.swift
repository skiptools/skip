...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.118/skip.zip", checksum: "c342840c308b71d6a2cdf104d2b1fcbf6a806ac76201390c73aace923efc024a")
    ]
)
