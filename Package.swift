...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.40/skip.zip", checksum: "416630c0dce52c2775f03ac92a6a82af16504c95ec4cc50fad22f4fd37eb4f92")
    ]
)
