...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.13/skip.zip", checksum: "eaae4506e3699049bae96a3ebcf0aaaa47287006b1d53db875aafaac81d4a5c7")
    ]
)
