...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.14/skip.zip", checksum: "8797b87c7082d4de168514e0257f42951b26c6494dbf77722045f7e66d999eed")
    ]
)
