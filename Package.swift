...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.133/skip.zip", checksum: "026d41a6f75b9d1c96db134dc8d2083b8db604802e8555391bc26af050ffe9ee")
    ]
)
