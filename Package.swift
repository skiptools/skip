...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.2/skip.zip", checksum: "c1ee7b7540dd063213c252fabc323542f278188e078434635ea5dc57317517c5")
    ]
)
