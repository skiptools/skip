...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.14/skip.zip", checksum: "e4d5917dbe2be1d0d0f1c7a412c9194f5b79c17b3b2d40e05e86c300ae99ef24")
    ]
)
