...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.11/skip.zip", checksum: "be954cbef6d75c23bc94c7ae494b884e7e8dc99f2aeb643eb266308693bc9547")
    ]
)
