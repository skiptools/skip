...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.19/skip.zip", checksum: "8cbf50fe8660092645055d8ddd2b869e99d668414f2059233e4439d59f1364fd")
    ]
)
