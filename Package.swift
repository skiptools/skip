...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.64/skip.zip", checksum: "b7b35c66d7287cc8ac302343f7bac777c681e6ebf69d91cefcdb96b28f8fef44")
    ]
)
