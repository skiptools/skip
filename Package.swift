...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.122/skip.zip", checksum: "317b56e880b76705ea36ba5af09bc3708adb7dffa1745f07f34732c0b711dcb8")
    ]
)
