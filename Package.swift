...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.5/skip.zip", checksum: "7ced3c88db5f2c1717fc77c09e5290f4607be07c361e8ffddc03924234bdcb6d")
    ]
)
