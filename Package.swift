...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.84/skip.zip", checksum: "f69fb5c2fe6e41a8820c1c6a735355cf4e874b849d47cf51f3225e377799368a")
    ]
)
