...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.5/skip.zip", checksum: "8f0ca029d632393186ffd5e3f8e14ee9cc75b7a63b55a4c792568961c663ac7b")
    ]
)
