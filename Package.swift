...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.1/skipstone.plugin.zip", checksum: "e42c2c9e7d22e67b1dbbc2efee08de2b90791cb5b6f083ed57e90cfc6760289c")
    ]
)
