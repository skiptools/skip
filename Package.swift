...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.41/skip.zip", checksum: "6ca508105a886c933ae08aef248332a21baa1ec02e6cb7a6db39722b65b51470")
    ]
)
