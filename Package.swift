...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.10/skip.zip", checksum: "fc6d3e357f1d46f4bbc108ee0a566067048be7fc845aa8290893b55861778c7a")
    ]
)
