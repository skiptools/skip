...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.1/skip.zip", checksum: "8dab964fac70ea2fc95d44adbe7acd88356c98ddd544e0ed5ee8aaa1cfbb6e19")
    ]
)
