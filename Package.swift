...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.1/skip.zip", checksum: "0afe3220aae16ec19d6fb31a2b7ffca42a036b7292a73a59cee5557535be8ec3")
    ]
)
