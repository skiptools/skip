...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.22/skip.zip", checksum: "ba6f316e8e278325633a9033aef9cd5abfa982e2c0eccd115eb0f82d2990e671")
    ]
)
