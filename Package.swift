...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.31/skip.zip", checksum: "0410b1b5507dd1672e5e6dd9233ae9631e398d331ca36a4d63bafef39376ed0e")
    ]
)
