...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.8/skip.zip", checksum: "c69818482224e39f96a481daf5a3ec44de54c4109dce3b37e29e478dd74eb46a")
    ]
)
