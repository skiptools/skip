...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.94/skipstone.plugin.zip", checksum: "e15b85d26d3534299f062e3a260c91a2ace27c5d6d8189e8edb94d91a47f49a2")
    ]
)
