...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.38/skip.zip", checksum: "7b0ca19a7cae312dee3f94dabb86dfaf1f6c2f654e5e4e2d91d91edde70b3097")
    ]
)
