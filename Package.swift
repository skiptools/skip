...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.3/skip.zip", checksum: "49f60df5819bb36a4c16af3b6fdf3eea42eb71e8ac7d5cc6f8854e9d215afcb3")
    ]
)
