...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.6/skip.zip", checksum: "dcb2e81c5cdf05d76ff2f79343a2536cf30d36812350286280c29adb7efd94e5")
    ]
)
