...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.46/skip.zip", checksum: "bb2d7ce8ec76bdb87e31d8bbae9fb2712db765c286c04062bcd1b773b470b2ac")
    ]
)
