...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.21/skip.zip", checksum: "885673fee41b46088bb590d57452d1a6210cab138ee9300b33f7864940af6b22")
    ]
)
