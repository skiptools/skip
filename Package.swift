...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.133/skip.zip", checksum: "683fe8b1435afc0f96d193d0b8011faa725602d8bbe846d0e22b1c09e94c0c67")
    ]
)
