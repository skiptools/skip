...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.8/skip.zip", checksum: "f60fe592b2819b53b6c075a2852fbaa95126d72f943c3d20a323777862cb52ca")
    ]
)
