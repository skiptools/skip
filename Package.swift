...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.12/skip.zip", checksum: "401ea857a1a94de0f740dc3992c7271bafab037b645bc7bc61a406a48d210ec6")
    ]
)
