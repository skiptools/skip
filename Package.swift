...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.4/skip.zip", checksum: "444bdb6a8fccf3a709afa8ba4ac400c940f2bf12c99abeed9093596f65007f24")
    ]
)
