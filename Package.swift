...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.126/skip.zip", checksum: "9c07ab2c8f09b5afa94f0f645f3967269cdfcd2212d97b0b5fecab7b650d772f")
    ]
)
