...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.131/skip.zip", checksum: "a23f31b3b2f2614cad568a8f8ab748b206164715b0b276fae0751ffcceacfbed")
    ]
)
