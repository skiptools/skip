...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.56/skip.zip", checksum: "b614bed2aae4cd7182d3c4364b0fa3fb16566435f40dad4141850ef11df963a5")
    ]
)
