...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.49/skip.zip", checksum: "0043fc3f8209cff2c132c1388971552f8c40caf5d9e10f7289fabcd01d690a88")
    ]
)
