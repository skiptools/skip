...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.33/skip.zip", checksum: "d7ffc55b79673c78b64f0958d8897e75a86d6b2da26a4baa47bb249f18a39db3")
    ]
)
