...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.4/skip.zip", checksum: "4a925c395d151b9c04d401e8dbc80da705a2b65cbbb76e8faa8890fa1a7d390e")
    ]
)
