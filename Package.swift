...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.50/skip.zip", checksum: "c0c14206786dc9c2a79c86a61374efde42477615a96ac2dd47b8c340b8f512f8")
    ]
)
