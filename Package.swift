...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.52/skip.zip", checksum: "03753c85e396dc3cd7b817790aa823e43b973636e031b2f93833ac80d3d85300")
    ]
)
