...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.23/skip.zip", checksum: "27c6b36d3f0d81d3b545a2bf1e53ace6f35d8b70b9bb1909ddcf81bb33bd7ff9")
    ]
)
