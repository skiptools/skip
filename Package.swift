...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.10/skip.zip", checksum: "80373ad2a370ef7ed980352974843c40748c2d212aa939bb1d14c4e019cb0553")
    ]
)
