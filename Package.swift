...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.108/skip.zip", checksum: "b42b585a0179c2099605e6a71e484fa4809cd9311e0b10df109fcaa52ec41353")
    ]
)
