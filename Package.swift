...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.92/skipstone.plugin.zip", checksum: "88bb39028e5a9832ce5825923e0187bee618d5b13e20a1427b29bf2c4d421c5e")
    ]
)
