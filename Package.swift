...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.28/skip.zip", checksum: "dcfef672481f9e883c7c10c0d5d2a5fb5f9b510d8f305aab4dab0076f2691abf")
    ]
)
