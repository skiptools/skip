...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.0/skip.zip", checksum: "f4d770cdcc9e451ba6986d6bbb3b260cace5a72628cc9a60f670c6353e2b9f5f")
    ]
)
