...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.11/skip.zip", checksum: "7293a2afd3156350939ec3c87cdbf933e337a4b51be224fa4320468422618143")
    ]
)
