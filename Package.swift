...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.55/skip.zip", checksum: "17d79ac2a7ab5a669c6c24741e091390055ab0ce7685a36c5c96ed21ed6fb6f1")
    ]
)
