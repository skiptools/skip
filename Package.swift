...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.25/skip.zip", checksum: "c4a8d2d288a9f081430ab77a9ca7cb24566f98ef1bd0386a76f54f72592d4d68")
    ]
)
