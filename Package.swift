...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.134/skip.zip", checksum: "ef45653c66dc66a5f6ef84c7bcabfadd7e849bf8a130cbe7dab6c347363111e4")
    ]
)
