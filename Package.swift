...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.127/skip.zip", checksum: "d55f85b3ddcd615612e1ac0b0d6ddc4b72401e184597b16e11a316abaf819ccc")
    ]
)
