...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.12/skip.zip", checksum: "ade69156e074ffa6f1c3499e512f0e09adf927a7348f2201e3e50d8588c0ce8a")
    ]
)
