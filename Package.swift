...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.24/skip.zip", checksum: "c9558248ef7bb1a83805f891385ebd4af522b821a0b4ddaa4a3f6f12086f1dd8")
    ]
)
