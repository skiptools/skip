...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.9/skip.zip", checksum: "c094cbcc59177af268a0915544c4624937d854e48d41af557185a9f4a44f1398")
    ]
)
