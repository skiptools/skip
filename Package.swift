...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.35/skip.zip", checksum: "b7dfbd473471b1d79634eadf1212f36f9568905fa8c0f775a5429a8b4afcea3f")
    ]
)
