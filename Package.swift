...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.52/skip.zip", checksum: "88387035a4ac9c9832afac8d8b0d90577d852427b02ac2e808c50c4a722fea5c")
    ]
)
