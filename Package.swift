...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.2/skip.zip", checksum: "4621e6804bce456ae386560e57aa88a072dc54cc65f608a81bfc9cf7fbc7bfb3")
    ]
)
