...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.23/skip.zip", checksum: "fa962fb707a08c6494783b35fe4265161cc7f3c551a5ad3a9ce5a13046cf0dfc")
    ]
)
