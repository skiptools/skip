...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.4/skip.zip", checksum: "b57c86e7f9db781e493528aab9eb70c5d8a2b9b2763fc2423ba819031fc1b86d")
    ]
)
