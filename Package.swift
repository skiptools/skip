...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.47/skip.zip", checksum: "981283481cf2cf8c065c619435cb44561dd5350dd41475d1a3c5ec8d1061fb8d")
    ]
)
