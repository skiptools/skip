...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.41/skip.zip", checksum: "60823d8ab24e6a75fb322471bd85a95334b595db574068ba2ea05f124ead879e")
    ]
)
