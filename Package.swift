...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.56/skip.zip", checksum: "d879f7e6cf5513f5482934c56b2df6069aa9c7b7b0c86aeccaf30e6c82defd99")
    ]
)
