...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.11/skipstone.plugin.zip", checksum: "232d6802dacb297dba928a0766924aa3fa0e4a79532762eb3a9a639be4f2061d")
    ]
)
