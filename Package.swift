...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.5/skip.zip", checksum: "4ddb26830ac2741cfd8976ff032cf1c67e19b776e9fb3fb0c97db7ec5c6d73c7")
    ]
)
