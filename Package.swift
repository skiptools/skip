...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.32/skip.zip", checksum: "65c7a6e4c16b0259992948d4e824d339bae94c3adc54655ff7b7b0b1ecd290a0")
    ]
)
