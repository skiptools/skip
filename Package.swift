...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.73/skip.zip", checksum: "3e08e04036c715150b4f873b56bed40f538a820ef0a1a157d82f177b0f9720be")
    ]
)
