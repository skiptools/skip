...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.0/skip.zip", checksum: "a57068855cadb6dbe6c9637b8f24eb713c7313abc59df6bce57d98028e650c87")
    ]
)
