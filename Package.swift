...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.26/skip.zip", checksum: "ca4af3da4bc3e491a974d42dece08046ebe6f65012f6f9902d71552179520460")
    ]
)
