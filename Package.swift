...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.74/skip.zip", checksum: "bd9deae4eb04039d7c0c57eb1b7a346f8fd9d04719bb537b4bb8ec5a7bafd20f")
    ]
)
