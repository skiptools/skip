...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.10/skip.zip", checksum: "917579f6b9d42158a8c86e88aa36e18f9684b9faf4f7e6a75d2bfb9a519f5ba6")
    ]
)
