...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.43/skip.zip", checksum: "e79863b381b876d259c13b3d3d959dd11149d603964ffc2f4edd846a5a58b379")
    ]
)
