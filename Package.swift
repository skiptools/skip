...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.7/skip.zip", checksum: "fc52bcf6363a289ee6434380f6af6a25b2d9835f4add7f3015492661647bfdc4")
    ]
)
