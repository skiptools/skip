...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.33/skip.zip", checksum: "fe0ce69cd850151b2a8bd37d2f847eff175e8ef97f785c6d7c838dc50e5d06b0")
    ]
)
