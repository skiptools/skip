...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.60/skip.zip", checksum: "685a5a1a855fd710621f19670f0fcc8d74a415517d9a6c9547c837c2a1d3f5ac")
    ]
)
