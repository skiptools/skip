...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.29/skip.zip", checksum: "6bab111366b9c6c4a2c6c5d6cd21fb9496ec113bc5d137f7af325fb047ed4f2d")
    ]
)
