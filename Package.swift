...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.141/skip.zip", checksum: "9296b3045c0ef1e3bba121acd43057557bb7e578c7a04adbc33df58f6f34bc46")
    ]
)
