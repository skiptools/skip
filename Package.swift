...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.17/skip.zip", checksum: "67ad5f6deff461b75e9f09b1d94d3617c0f72735b414875cd3865174657280bb")
    ]
)
