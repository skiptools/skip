...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.37/skip.zip", checksum: "21382d553a60b441b8840974b01270495100bf3b90cdcffe47c5ccba11887edc")
    ]
)
