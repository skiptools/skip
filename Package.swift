...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.11/skip.zip", checksum: "213f97930cb816248d430708de873a64509e65bdf6d9cd9323a884d94b5d19f2")
    ]
)
