...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.2/skip.zip", checksum: "b2da8c40f613208476b2662d85240a7e72ddb1d3d73b4a90e25ec9b0274e12f5")
    ]
)
