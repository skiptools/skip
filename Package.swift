...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.68/skip.zip", checksum: "cb5288fda4dde18e90011ead513b899ff0bfeba7f682982c68d17d89cc0869eb")
    ]
)
