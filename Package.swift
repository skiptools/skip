...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.18/skip.zip", checksum: "e9d97f13ca0171d767d1e73cb5c1c2ce06d6f3fff4804016a67300a1dcaa02c4")
    ]
)
