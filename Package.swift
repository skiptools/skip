...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.21/skip.zip", checksum: "f878da740a4664a1ee6d1bf38aa1529e250bf446217221e6feca3af4059ccff8")
    ]
)
