...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.20/skip.zip", checksum: "600ba2e29ec72030a84bb0e7a21b565e65a324ec94a97176e229c0976c025851")
    ]
)
