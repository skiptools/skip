...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.115/skip.zip", checksum: "4016d1e12cc947a19eb88e89094331747108138f4a92760cd551472966081637")
    ]
)
