...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.88/skip.zip", checksum: "77680228d2a50bd4aa05a8c54fb9915ce9e70614e777e164bba314dad5294881")
    ]
)
