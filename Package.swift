...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.36/skip.zip", checksum: "ea952c2b7e1ecbe977afcb2c94e84441d765d456e583a3eebd1a9fc572fd1e1d")
    ]
)
