...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.52/skip.zip", checksum: "423fc8ec72d64cd3bda0de096a50fd287818446351d23dc7dc3f609055834176")
    ]
)
