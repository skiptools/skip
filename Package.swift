...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.11/skip.zip", checksum: "240e47a442f7c027174b7de6b88070a8238715e0e15e576661058aff560c23ea")
    ]
)
