...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.10/skip.zip", checksum: "e23ff608a24ca8dfc16eb7de2177bf6029583f3b9ea57e060ac9853bf62d83cf")
    ]
)
