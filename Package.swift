...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.97/skip.zip", checksum: "182576e54c5480d77cfbf1f59fd0b72cf6100fb7833f689168a27368d272909a")
    ]
)
