...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.48/skip.zip", checksum: "b4c893f5ed5964357314224ee7d58b22aadb9c9182e76d6c3eeec19ce7d195c1")
    ]
)
