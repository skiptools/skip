...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.46/skip.zip", checksum: "4df4918185a8406a4b681b2dcccf55c99998a7c9267072424113d3f0b0735eed")
    ]
)
