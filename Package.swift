...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.34/skip.zip", checksum: "d18d982b85e4b6d1d03b7626c0fcc3a82b35e778ca2f3197199876b14e463d89")
    ]
)
