...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.8/skip.zip", checksum: "ac1e6465ca12e60c7182a63076240808042d45e98b83326e0df4923860529617")
    ]
)
