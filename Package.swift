...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.32/skip.zip", checksum: "48be3f590594a290f299b4e32cc9a525ae419772f1bdbfab31c12dc306731a67")
    ]
)
