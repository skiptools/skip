...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.0/skip.zip", checksum: "d4f8c4f747df1af98a5ba61607e3a29dc756ea754a68905bcfba6159aeec74dd")
    ]
)
