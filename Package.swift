...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.15/skip.zip", checksum: "70eca4b0e054bdaeecafd56dc8f6bb5323ea41d0f7b979dfdc9dc46e624903f2")
    ]
)
