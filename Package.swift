...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.10/skip.zip", checksum: "a000750ca2825e0d0a04df2b6142e92fe2af4f0f362770f8ec26d6bbd3f60e65")
    ]
)
