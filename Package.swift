...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.5/skip.zip", checksum: "0bdb30fdaaeeeef7cce61e476466cd98a441b53f4e1a57e6c28a89c8d8f756f9")
    ]
)
