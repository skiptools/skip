...
if let localPath = ProcessInfo.processInfo.environment["SKIPLOCAL"] {
    ...
    package.targets += [.binaryTarget(name: "skiptool", url: "https://github.com/skiptools/skip/releases/download/0.3.12/skiptool.artifactbundle.zip", checksum: "f199e3f6dd01048253f9dd49c9388f22cf069a47c7f0aff629e6c41defdda837")]
}
