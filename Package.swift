...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.4/skip.zip", checksum: "29631b81538c22cc0d3d20d92c077169587e0d42f179bbc95c5f8efcfd98a3b6")
    ]
)
