...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.54/skip.zip", checksum: "9f7fffdbe4adb9a22694ffe781fe72686e756d885f120a96ae1c981b3a0ea32b")
    ]
)
