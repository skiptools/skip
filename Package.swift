...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.12/skip.zip", checksum: "0e7cb25fc013bc3708f0a9bee83cecbacef07f4b3ca2779672ea1ee70f050d5a")
    ]
)
