...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.6/skip.zip", checksum: "e3b7b55f8e857d9f1dd1ed7246593feeda85ac1040f9498f03ae33e26f10a8e8")
    ]
)
