...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.7/skipstone.plugin.zip", checksum: "0ac66126121ddabebd509f33b7fb7ee0a896790dab4ab0c6c9378f46d544576b")
    ]
)
