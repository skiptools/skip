...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.93/skip.zip", checksum: "30189da9a316dbc74373ba76b74782c97e5d3c6708e7eb093dd1c101ade8d933")
    ]
)
