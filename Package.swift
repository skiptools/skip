...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.88/skipstone.plugin.zip", checksum: "cf2a5881f85705c638ed58a2e7858da45af68acc6e658fc63c32f02325f221fa")
    ]
)
