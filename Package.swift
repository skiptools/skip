...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.86/skip.zip", checksum: "318737b1ea8eb84ba737ccedc46479e5bf78c097ad018503c9ff57b25417ad5b")
    ]
)
