...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.6/skipstone.plugin.zip", checksum: "31e79965f080bdc77e8df879146260a5c862d75135a44ac96b015327233ea891")
    ]
)
