...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.140/skip.zip", checksum: "7b2533216bab2347e467ee34ee290b0808959e3d69de25d6f58a8d28e24cedaa")
    ]
)
