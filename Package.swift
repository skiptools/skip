...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.25/skip.zip", checksum: "b253754ef949bd6249a92cf6545cd366d99944161184236cb8217f5caea394da")
    ]
)
