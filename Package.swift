...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.23/skip.zip", checksum: "e2d4289a37d92ec05f48f5c322c94c41e7016687ce6a8d692adf98f603ad1ec2")
    ]
)
