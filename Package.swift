...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.2/skip.zip", checksum: "e259fe5e5ac0be838594375384c26de3401c94c2ed17be57a3720577c1218a08")
    ]
)
