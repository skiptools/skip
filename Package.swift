...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.3/skip.zip", checksum: "ec06abd2b964feef176ffe38407492bbd7b2c5efc335a9156158ffa17c432e71")
    ]
)
