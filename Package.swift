...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.36/skip.zip", checksum: "371285725a60a808705d7d27a0187ade02aaadefe46ece44e8ff3b54c572620e")
    ]
)
