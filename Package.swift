...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.34/skip.zip", checksum: "8a3261c9d1c4b30bb14120920921e39d651871ea34fe0c580c43b44c9c868faf")
    ]
)
