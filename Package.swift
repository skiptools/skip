...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.142/skip.zip", checksum: "25143be791624b165ba43745de73f4bbc3ce7876940a30479622d57ac2888cfb")
    ]
)
