...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.0/skip.zip", checksum: "af95b3bcffeb289a24b9cf3e610d3455625d96361a22a678c19fbd6b1be0ba43")
    ]
)
