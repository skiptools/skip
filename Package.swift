...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.7/skip.zip", checksum: "c04ba0e4b2220f4414d160d3c227ee735f57bc1e3a20fef9a3702b4de8e0b809")
    ]
)
