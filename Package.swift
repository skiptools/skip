...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.7/skip.zip", checksum: "5cf5e90ed5fc2b30ac15248e660b162ae46b0b9d82045c1ed217fabe9bef952f")
    ]
)
