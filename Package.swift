...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.45/skip.zip", checksum: "ffc4f88d6fe9504a43a91c7908d95d1759c8d9dd200f87289e2ce4e64c0796bd")
    ]
)
