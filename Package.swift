...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.11/skip.zip", checksum: "324fa40ccf8ce8ba4a9a91baea0fd834b196c3998fa0e1f0a89e029c11629a78")
    ]
)
