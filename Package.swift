...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.22/skip.zip", checksum: "bb272b3e0723b69f4ef7c934347612b31002f640618794cd5c6bcf66b8d0c75c")
    ]
)
