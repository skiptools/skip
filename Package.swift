...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.130/skip.zip", checksum: "6e0bfed500d70b7829ad581691fce5db8d33cc472c5df390ccaef5223cd013fa")
    ]
)
