...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.0/skipstone.plugin.zip", checksum: "3f86ae534cb31527367b8bdfaeb2c175b403802404b40536f101dc32f36a449d")
    ]
)
