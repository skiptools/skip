...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.8/skipstone.plugin.zip", checksum: "698044a2ebfb878546c791c398a6758da7f5ca08d68b75c246f58bfd9fad0ffe")
    ]
)
