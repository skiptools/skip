...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.8/skip.zip", checksum: "24f8944b3f53cb035433b62d376741d10b9576eb555aa9b3c319b84a4cb61f04")
    ]
)
