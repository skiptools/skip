...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.20/skip.zip", checksum: "28012c2f3500c812e22d445d297d063affafd1773913fe5c90620162d03473e9")
    ]
)
