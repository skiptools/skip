...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.58/skip.zip", checksum: "cf4f96e79cdde0f8c5503139eff5d12bb5dc9dc7e6f0c3cdb0762317fff996e7")
    ]
)
