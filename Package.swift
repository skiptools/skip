...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.5/skip.zip", checksum: "99efb1f1ac81b82830e87c52c7dae229361acd2bf2d5ea23421e96214bc15e5c")
    ]
)
