...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.16/skip.zip", checksum: "cb7d65cdc9548c97ded0ec83e96640fe483e66c0011dfe5232b62ab53d89dcab")
    ]
)
