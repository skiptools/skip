...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.4/skip.zip", checksum: "b1a405ddc227e77653bb401ef3ba882ac940540db7c463d26a7564e9fd6e8810")
    ]
)
