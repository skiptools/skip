...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.30/skip.zip", checksum: "8557a61c6f1850beae142d800371012ddeb532c0c6409fac31b798b9c02f0522")
    ]
)
