...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.10/skip.zip", checksum: "abab0377ab09ffe40310ec76aaa7c999c74fc96f82a83053263c3aa7a8fa9f04")
    ]
)
