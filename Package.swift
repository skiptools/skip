...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.8/skip.zip", checksum: "67214de4d6cf602e9b57c6d246b5e42ab963f7a06d0dd79952700563eddcc3f3")
    ]
)
