...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.43/skip.zip", checksum: "be73136fccad56c77f74acd5d1cb68ea5430b68d8dd09141333b5b3a2a855882")
    ]
)
