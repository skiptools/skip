...
if let localPath = ProcessInfo.processInfo.environment["SKIPLOCAL"] {
    ...
    package.targets += [.binaryTarget(name: "skiptool", url: "https://github.com/skiptools/skip/releases/download/0.3.45/skiptool.artifactbundle.zip", checksum: "f85d172cc801b2b2a1034615ee9e265150b565baa73832601906fabfdc959b64")]
}
