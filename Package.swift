...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.57/skip.zip", checksum: "6b65b50ebb7f6199adaced8d4f05207b3384c7704b33ef48eae25722e7a1d4b9")
    ]
)
