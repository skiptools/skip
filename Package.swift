...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.72/skip.zip", checksum: "7538cd513453760f86a72f1043551a22fdc515360785ee3e6cfdb317871bd90c")
    ]
)
