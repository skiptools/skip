...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.51/skip.zip", checksum: "3b171fc22bc09aecafadc8d844953e0c768586286c539bdc6aeac7f790d4f98e")
    ]
)
