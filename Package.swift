...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.116/skip.zip", checksum: "56914a964646015cbe7bc2397bac7c967f9b0b65c20d6a28f93c7a3b87d5dcdb")
    ]
)
