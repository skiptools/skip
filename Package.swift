...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.61/skip.zip", checksum: "107a9e0a1656a891dac1637188a1eb833a5cebc86e0fcaf89524f57a602025ea")
    ]
)
