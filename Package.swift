...
if let localPath = ProcessInfo.processInfo.environment["SKIPLOCAL"] {
    ...
    package.targets += [.binaryTarget(name: "skiptool", url: "https://github.com/skiptools/skip/releases/download/0.3.9/skiptool.artifactbundle.zip", checksum: "29988b18779af192637384b3f3c0408d745fe61c64999652332e096a9c1ef40a")]
}
