...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.6/skip.zip", checksum: "8a7152b522d70072d0b53ab6fa5dc5e6714b5157817773a71c4ae6e062079b59")
    ]
)
