...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.139/skip.zip", checksum: "8e4c93ab4c381f6e26897c08389e5bd64bce64ef6076c8888169265c63db5d80")
    ]
)
