...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.7/skip.zip", checksum: "54add9f868041e2003a3e03ebcd37b9d15bad0df2f55e8be15dd351a566f8770")
    ]
)
