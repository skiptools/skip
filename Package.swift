...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.123/skip.zip", checksum: "8582414a85cf7bde0d473fa55b67c9bce1f1e65a1760f332f0d5c0c859662e43")
    ]
)
