...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.59/skip.zip", checksum: "1de729f5c9a6d0017f77693cbc196b032e54d2f14625fe1de4cfa7e95b0c2c8a")
    ]
)
