...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.17/skip.zip", checksum: "6c8134e15b7ba4b63f885daf5596d9dc0618f8c93891c17e899feaa30c68653d")
    ]
)
