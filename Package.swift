...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.12/skip.zip", checksum: "e07ac566de970d4ba7517de935c3ef2e6741dec8db5a0527995d90f747301f0b")
    ]
)
