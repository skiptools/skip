...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.22/skip.zip", checksum: "8ae975a7fe69ce78211104f63689476b8d9a774e11c9e77036f41f3f8bc72cc5")
    ]
)
