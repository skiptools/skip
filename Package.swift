...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.28/skip.zip", checksum: "152aa0ad4e5eb01f3eee724cdb13e801e674e8fcd366a4080291ca24d3cd7d7d")
    ]
)
