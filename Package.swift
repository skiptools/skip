...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.31/skip.zip", checksum: "b1cb967d975d170e354ca37f5414346e19310c6edb3b5bae9b6917cecd6fe92c")
    ]
)
