...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.110/skip.zip", checksum: "18e84c1e3ddd027675a080b287319ee594238d184f49ccccf214955859f0d540")
    ]
)
