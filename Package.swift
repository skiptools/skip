...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.8/skip.zip", checksum: "0f93daaac43f4f5791d137d061bef75fc0f5d99b58cdd028c80136e0b0743474")
    ]
)
