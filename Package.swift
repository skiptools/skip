...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.111/skip.zip", checksum: "f0a8da2da9634d58ac3ee9fb0e298739d197f4973d6d1b2fd6afa22db2e41dc1")
    ]
)
