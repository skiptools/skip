...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.0/skip.zip", checksum: "94a3f9c4dd2348b6de18e23822a54e83ae8a3bc3fe317d111c7f1ce75cb2e60b")
    ]
)
