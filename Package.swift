...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.10/skip.zip", checksum: "e8d006a428cc6e3f49db3ae8afb227b4fbf239ef952a557c5afc8743cd5569ea")
    ]
)
