...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.7/skip.zip", checksum: "a652441a3972fef6246889d831837cd5bad90bcc494c49d3248c6cfc28bae358")
    ]
)
