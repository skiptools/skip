...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.9/skip.zip", checksum: "257b106c98be0f9a22f259116efe474ace91b4d41cc71b142e7a8817fd047896")
    ]
)
