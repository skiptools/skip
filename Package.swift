...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.91/skip.zip", checksum: "bdc7205ef08e099c2f67a31a2f8b3049f536bae3765280714f884c512f60e2df")
    ]
)
