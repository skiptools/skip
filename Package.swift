...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.9/skip.zip", checksum: "5dbfd50e7e65f6d01eb3a116e099cb628bdb5715705b4892ad84da435d5f3dc7")
    ]
)
