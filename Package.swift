...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.10/skip.zip", checksum: "5012392d53c8573dab95ee115e84e33ab25817a9e8d628b4700b8df04f58379e")
    ]
)
