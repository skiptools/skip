...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.12/skipstone.plugin.zip", checksum: "2df46c0bd5998be18d3e39c2277c41af3eae2995aa6f8d5b88ff9c6f3d51396a")
    ]
)
