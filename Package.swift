...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.22/skip.zip", checksum: "d7ad502a339d0da132a8611d7c403c73cd3c7259d60e66e6e1b01483dfaab5e2")
    ]
)
