...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.13/skip.zip", checksum: "b97eb0c6c77c853c406462d3cba1e2f4c5ebc7f615fa5e9e182dfcedd2a923fe")
    ]
)
