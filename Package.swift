...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.3/skip.zip", checksum: "851c261650f684517d7782e5fb561e860f40ea6791cb8b9b68909dc6f78741ca")
    ]
)
