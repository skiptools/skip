...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.81/skip.zip", checksum: "2cf7d81160efd2fdd349d7d7b818669dd8bd97fb6c928838ef8ef36d4efb2778")
    ]
)
