...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.3/skip.zip", checksum: "6820c89b3bac025af9ee93c38468e47920d23ce83b5fccca1e509a8934b4088f")
    ]
)
