...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.119/skip.zip", checksum: "cb8b51b25036650b1a7556db74fb8b6c7df6837dc839a3d64aa0216db28de495")
    ]
)
