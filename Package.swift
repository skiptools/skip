...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.135/skip.zip", checksum: "93335872d03347d65f1f626d199284a82559494d9b2022a00dda637323787bf0")
    ]
)
