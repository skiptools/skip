...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.20/skip.zip", checksum: "eca8c68f4880aa796bbf9ac25de05adc5c02d5afc454a603699d350285b04e69")
    ]
)
