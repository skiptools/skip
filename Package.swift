...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.9/skipstone.plugin.zip", checksum: "de4dfdfe779c067cd61905839b7de144dc1fa2dae6dda63cb4f8d753315223e5")
    ]
)
