...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.27/skip.zip", checksum: "9348680e2a8d10166ec48bcf8709979cb321080ef44ee616b61d5cc3f7419b91")
    ]
)
