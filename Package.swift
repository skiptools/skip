...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.53/skip.zip", checksum: "cabd2125fc0865de69879a0a4c609a9b39c52f0b1480f225ae6ef647426a1822")
    ]
)
