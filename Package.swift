...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.24/skip.zip", checksum: "75d2fcba04a768a4b7d965f4f1b7cc38d21459853f6200f12dcd79c6aad61c9d")
    ]
)
