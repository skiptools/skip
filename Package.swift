...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.0/skip.zip", checksum: "a177abc8ef714742fa87d4fdd6b81bc6c3bcc10f4feb5fa84f1858212d77b4dd")
    ]
)
