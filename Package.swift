...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.13/skip.zip", checksum: "6815fc57a5406d4458b8a196394bf7f03e4c1d1879c3b9cced56735538912ab7")
    ]
)
