...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.3/skip.zip", checksum: "577a0ec88a4f4b88026f6297a5fdb671bf09235ec242b308499d44169a082e57")
    ]
)
