...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.1/skip.zip", checksum: "6859c1691b85b679044314da48478910a778435c9978ae673571dcf7ae5c4a0c")
    ]
)
