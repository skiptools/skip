...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.6.6/skip.zip", checksum: "3c8d98fbc5762955ee50142aa33a8b152f207dc059d1c8f4743009ff892d7b4e")
    ]
)
