...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.0/skip.zip", checksum: "46d6c6e1f36f8b260e5e26edf325ad973fd66bd3208d25054f196431ef04dc21")
    ]
)
