...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.29/skip.zip", checksum: "8765f24294d6fac856257f2c8dd297e0142337045dc5dfaf876f962d83b34ea9")
    ]
)
