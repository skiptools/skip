...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.14/skip.zip", checksum: "b86478592701200665eb6f8c85fdb76b57910d927ba56dd13108d76047b933eb")
    ]
)
