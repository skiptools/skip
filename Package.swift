...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.4/skip.zip", checksum: "b4fc6cb12ba28374b0f9e8e2a2ebc918f0681247d0dcc85da894b325b52a4c36")
    ]
)
