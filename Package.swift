...
if let localPath = ProcessInfo.processInfo.environment["SKIPLOCAL"] {
    ...
    package.targets += [.binaryTarget(name: "skipstone", url: "https://skip.tools/skiptools/skip/releases/download/0.5.48/skipstone.plugin.zip", checksum: "efd2908d2fec7f0f0f847b4212c675e90d4f4102949f55aa598113178f78e0c8")]
}
