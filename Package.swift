...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.54/skip.zip", checksum: "40a58bd24a67bd65725ffe40f55e5a96b05ddfe68140a2dd43c3db4c1253e89d")
    ]
)
