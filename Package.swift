...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.18/skip.zip", checksum: "f3efb9eecaf908446d66a16e7907bda056cd818c49a5c565a0d87ee56bc7688a")
    ]
)
