...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.16/skip.zip", checksum: "1594ed030753e0562b94402eea019a49f7b050e429f88e0dd0385b1d7c1a1d7a")
    ]
)
