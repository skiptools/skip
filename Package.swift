...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.1/skip.zip", checksum: "48f6c03f73dc7b004871cb8c09b1347f23b04737b5193d4d872434e1f426470a")
    ]
)
