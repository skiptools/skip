...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.3.6/skip.zip", checksum: "a72a6e9a2a9b5755a8cf77ddc437d6a5b97a31701ea7f171b028a31f005e809e")
    ]
)
