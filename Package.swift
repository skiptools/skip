...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.50/skip.zip", checksum: "a3097fcbe2f21bddd157459dbe5b3b854d43af9570411952b7ed6f37fd6dad51")
    ]
)
