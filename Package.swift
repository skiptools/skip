...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.27/skip.zip", checksum: "2006b038a841a65b037a1bc7ace20ccc562531789056b8b16e5d52f5665151ae")
    ]
)
