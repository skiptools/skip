...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.30/skip.zip", checksum: "8f1ec0f585ab0cc0b2f5b22f2f69bb809bc409dd007662c3e2e7ce405b671065")
    ]
)
