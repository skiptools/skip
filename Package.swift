...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.17/skip.zip", checksum: "f8b76e98c3a6eb7170d0ab2d4eb6839d6ac9fb676ea682ff7226b05915a10193")
    ]
)
