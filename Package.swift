...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.9/skip.zip", checksum: "36ba80d86985a499a36c4420862db686d31f4e50f5992010432512b5bd2419a5")
    ]
)
