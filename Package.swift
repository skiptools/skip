...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.10/skip.zip", checksum: "c4e4e68c439e650d6c8464f348f2797a75737c7490e0843daca3833aa4de4d6c")
    ]
)
