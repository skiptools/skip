...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.30/skip.zip", checksum: "651b75b0274134b33f7554c70ef9f6e8a316ac8485114b7e61b8e48e8f6470dc")
    ]
)
