...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.63/skip.zip", checksum: "39d4add052ee8efba2b85086085bccbfc44f937fe57aca7d7ed95656b558d76d")
    ]
)
