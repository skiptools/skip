...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.21/skip.zip", checksum: "76298bfaf3b08d14a875342cac53e98c45499d4985750e5fda0270c190ea8119")
    ]
)
