...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.101/skip.zip", checksum: "e0902b070718a489278430de6117d26a91dc1a9676f014cafb935d6bc355da4b")
    ]
)
