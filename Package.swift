...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.10/skip.zip", checksum: "350d35747193f59e9dfba4b1665cb7a6e6f117a8e17bd843c52432bf0a5d6df2")
    ]
)
