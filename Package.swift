...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.11/skip.zip", checksum: "c114f4f1e68422bb3037008ce2144e826b493805658c837dd39c9f04a776aae3")
    ]
)
