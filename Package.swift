...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.26/skip.zip", checksum: "56d703c66c24d55fb34e25803e8bcad9a0b9bbe776c57a44e7894ef75b07559c")
    ]
)
