...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.6.10/skipstone.plugin.zip", checksum: "b877fb71d762a315d6e8040cdf8eb64bfd1eda3dbb431b028861eda43721fcb6")
    ]
)
