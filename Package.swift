...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.6/skip.zip", checksum: "7d6c800af250124e0d86f15e7d2ff2996ecb1c56c6380d72593395da6e17786d")
    ]
)
