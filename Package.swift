...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.92/skip.zip", checksum: "f8a9e332f0f1c199e2e78ca975a60cded45697a14492fcf3646c882fce55b21d")
    ]
)
