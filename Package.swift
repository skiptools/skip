...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.9/skip.zip", checksum: "46cabe0d8026b9fc23cb7506800d00248b60641791810bee0c280181a282e406")
    ]
)
