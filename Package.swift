...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.10.9/skip.zip", checksum: "7228189e61a2c6df213acad4461def36bee9c6ef88fbf3e09c613e5bc04db39c")
    ]
)
