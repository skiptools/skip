...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.19/skip.zip", checksum: "7df73cdcff618d55c8c54b671e51000363a33b53c4742cabe93c076b2ae768ab")
    ]
)
