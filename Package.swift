...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.6/skip.zip", checksum: "4c0b644869f5e48fbcfa2df7f7d748b9bbe3870b0c88b0053dc42fc34e02d010")
    ]
)
