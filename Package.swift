...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.2/skip.zip", checksum: "3a8aa18b5f41fb6ed734d959483f1786310aeafaf6c0430d0ea8241a73a35900")
    ]
)
