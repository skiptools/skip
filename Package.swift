...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.40/skip.zip", checksum: "8aacd0f2bbf53675acbb47bade13211a403146d2cb9784ba3fd368f1da35a05a")
    ]
)
