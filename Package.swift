...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.91/skipstone.plugin.zip", checksum: "17c0622022129969c4f27f70e580af5cd54b121c688204a2954ed10ec6e74b32")
    ]
)
