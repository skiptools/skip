...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.47/skip.zip", checksum: "c9d4c561d96bf5ae368b565d429012ff5b891ebb7cf390ca81c1484c39cee00a")
    ]
)
