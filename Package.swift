...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.93/skipstone.plugin.zip", checksum: "1c776936af9ecb2f2be950d7061f094b5e51ea28c51889c97f1e0dffdfca323c")
    ]
)
