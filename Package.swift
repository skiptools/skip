...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.2/skip.zip", checksum: "e95f3c1f6393157577c4572aa0bd411fb8f8b9a05153ca8c77cf7cbf30eeb75b")
    ]
)
