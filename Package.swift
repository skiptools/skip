...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.2.21/skip.zip", checksum: "c0ad6ba9b4fb22006c7fa2aae076e55da339bee781f6283b8906340a09e66f39")
    ]
)
