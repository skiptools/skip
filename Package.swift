...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skipstone", url: "https://source.skip.tools/skip/releases/download/0.5.87/skipstone.plugin.zip", checksum: "7c9154dae8af13ee65ecf43039a736c6d33be600ba3ed5fcf36795113586da62")
    ]
)
