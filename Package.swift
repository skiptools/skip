...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.1.5/skip.zip", checksum: "a34697633ea3dfee405b5c6bb989c6ae49febf770acd699f015ff1225a106a52")
    ]
)
