...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.9/skip.zip", checksum: "69f9a81e3c3facbeb1c59ef3acd3d728d19166bc14385a290fead3e10572ad75")
    ]
)
