...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.4.4/skip.zip", checksum: "71a8b91f22e738e2d53ef3ed02fe8dea9da8356d830357c8eb0d5dcb46292d9f")
    ]
)
