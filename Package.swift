...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.89/skip.zip", checksum: "52b3fe01fc265ec64bba3701c008bf2a1eb0862720e0120488dcc151e2d1ccfd")
    ]
)
