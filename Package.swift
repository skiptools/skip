...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.51/skip.zip", checksum: "ffea494c3428d2f2c47427aea66f14c1ffe2539f892a5272c0b535f9d4fbcbf6")
    ]
)
