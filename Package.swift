...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.2/skip.zip", checksum: "dd4e905d47e4c9a61b6b71726e99a3e1598c487e751580f5773f57ba668c3cbc")
    ]
)
