...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.4/skip.zip", checksum: "d38bd4de902d21224673e1c0ceb8a54c622f58af65199204a4902c7e1baeca12")
    ]
)
