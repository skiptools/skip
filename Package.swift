...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.0/skip.zip", checksum: "67b17a857c1e2c32efc978eb85297e87fa530cad0042dd73d1441ff8c46f7899")
    ]
)
