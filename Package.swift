...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.112/skip.zip", checksum: "c639c9cf62beeb4a1c57e41a2cd607c89e2c41520e1035eb1973cafcb3a5b19d")
    ]
)
