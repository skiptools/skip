...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.9.2/skip.zip", checksum: "8639c79cd9d4a4653a0a9de088729ff802fa84b1e9a59502e41b7d67d24e228b")
    ]
)
