...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.5.0/skip.zip", checksum: "0fbe62d4e1a454cb74cd10c7c89f1cc81b7c2f08be35af640c4e805e4c3772ce")
    ]
)
