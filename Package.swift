...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.6.132/skip.zip", checksum: "f3988d4fd97b0548cd419586676a9d438b9707eb10cff235a811eecb889bef7b")
    ]
)
