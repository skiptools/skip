...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.1/skip.zip", checksum: "e187ef9ffa2cc0c135cdcf416c244f145c955e10f293cb24f5223bd24c2ab298")
    ]
)
