...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.1/skip.zip", checksum: "0e73e8fdcf14555c6312319d0c57ebf3234f8a289baed187add80ea916229503")
    ]
)
