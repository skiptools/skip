...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.19/skip.zip", checksum: "a256a7f2d88347330779aba6c40965bdba2d2dbb52ab4a090bd2816017a45103")
    ]
)
