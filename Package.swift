...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/1.0.8/skip.zip", checksum: "1a176c195e0bcb434b6f2e23f4b3b1b9c0fdf0bd73a6336cb7fe6de315efb08e")
    ]
)
