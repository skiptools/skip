...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.8.3/skip.zip", checksum: "37a18ea4af2ab6ca1f71160904c6660e1e7bb27b187bd7252d37e9a1d6dd9624")
    ]
)
