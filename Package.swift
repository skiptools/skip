...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "skip", url: "https://source.skip.tools/skip/releases/download/0.7.37/skip.zip", checksum: "31c1e6694f62247a5fb6014060617150b9cc4763c67bd221246c82326eadefe2")
    ]
)
